...
export function SideMenu(props: HeaderProps) {
    return (
        <motion.div
            ...
            className="h-screen w-full fixed z-20 bg-black/90 backdrop-blur-sm flex justify-end items-start p-5 md:px-[5%] md:py-10">
            <motion.div
            ...
            <AnimatePresence>
                {
                    ...
                    <motion.div
                        ...
                        className="bg-tan md:bg-transparent w-full fixed z-10 flex py-3 md:pt-10 flex-row justify-between items-center px-5 md:px-[5%]">
            ...
            <AnimatePresence>
                {
                    ...
                    <motion.div
                        ...
                        exit={{ opacity: 0 }}
                        transition={{ duration: 0.3 }}
                        className="bg-black md:bg-transparent w-full fixed z-10 flex py-3 md:pt-10 flex-row justify-between items-center px-5 md:px-[5%]">
