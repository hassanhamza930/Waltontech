...
function InfoCardWorkflowSection(props: InfoCardWorkflowSectionProps) {
    return (
        <div className="h-[350px] md:h-96 w-full md:w-2/5 p-5 backdrop-blur-md overflow-hidden rounded-md bg-tan/70 hover:bg-tan/90  hover:shadow-2xl flex flex-col justify-start items-start gap-2">
            {props.logo}
