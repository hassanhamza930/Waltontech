...
function CompanyCard(props: CompanyCardProps) {
    ...
    return (
        <motion.div
            ...
            whileInView={"visible"}
            className="relative z-0 h-96 md:h-[600px] w-full transition-all duration-300 rounded-xl overflow-hidden shadow-xl">
            ...
            <div className="flex flex-col justify-start items-start h-full w-full">
                ...
                <div className="z-20 flex flex-col md:flex-row w-full justify-start items-start md:justify-between md:items-center">
                    <div className="text-2xl font-medium text-tan/90 px-6 md:pl-10 mt-6">
                        {props.title}
                    </div>
                    {
                ...
                <div className="text-tan/90 z-20 text-md font-light px-6 md:px-10 mt-1">
                    {props.description}
                </div>

                <div style={{ backgroundImage: `url('${props.img.src}')` }} className="bg-cover bg-center h-full w-full flex justify-center items-center mt-10">
    ...
    return (
        ...
        <div className="flex justify-center items-center w-full h-full bg-tan text-black/90">
            <div className="flex flex-col justify-start items-center w-[80%] md:gap-0 gap-12 md:w-[60%] h-full py-24 md:py-72">
                ...
                <div className="flex flex-col w-full h-full justify-between items-start md:mt-16 gap-10">
